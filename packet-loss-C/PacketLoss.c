 ...
 */
void summary(avlNode** connBSTRoot, struct node* closedConnHead, oos_avlNode** oosBSTRoot, int packetCt, int byteCt, double lastTimeStamp, const char* outputFilename) {
	FILE *file;
